// src/data/localization.ts (Final Version with All Keys & Translations - Full Code)
...
const translations: { [locale: string]: LocaleData } = {
  en: {
    ...
    hero: { // LP Hero keys + Original Hero keys
      ...
      aio_box: { title: "What is AIO (AI Optimization)?", description: "It refers to information structure and semantic design optimized for the AI recommendation era. It's not just traditional SEO, but a new way of PR that prepares the web so AI can easily 'understand' and 'introduce' it." },
      ...
      assistant: { title: "AI Shopping Assistant", subtitle: "Helping you find the perfect product", query: "I need a good LED facial device for anti-aging.", response_optimized: "Based on your needs, I'd recommend the Advanced LED Facial Device by BeautyTech Pro. It has 5 light therapy modes including red light for anti-aging that's clinically proven to reduce wrinkles by up to 25% in 8 weeks. It's also FDA-approved for home use.", response_standard: "I found a few LED facial devices. You might want to compare features and prices to find one that works for you.", panel: { title_optimized: "AI Optimized Product Page", title_standard: "Standard Product Page", text_optimized: "Rich structured data helps AI understand and recommend your products.", text_standard: "Without proper optimization, AI has limited understanding of your products.", badge: "Optimized" } }
    },
    featured: { headline: "Featured Products", subheadline: "Explore our showcase of AI-optimized product pages that demonstrate best practices for product visibility.", button_all: "View All Products" },
    categories: { headline: "Browse Categories", subheadline: "Explore our product categories, each optimized for AI discoverability and recommendation." },
    homepage: { meta: { title: "AIO Shop - AI Recommendation Optimized Demo Store", description: "Discover how to structure your online store for optimal AI recommendations and visibility with our interactive demo." }, why_optimize: { headline: "Why AI Optimization Matters", subheadline: "As AI shopping assistants become mainstream, having AI-optimized product listings will be a key competitive advantage.", point1: { title: "Increased Visibility", text: "AI-optimized products are more likely to be recommended by AI shopping assistants." }, point2: { title: "Better Conversions", text: "When AI understands your products, it can match them to the right customer needs." }, point3: { title: "Future-Proof Sales", text: "As voice and AI shopping grows, optimized listings will maintain their competitive edge." }, button: "Learn How It Works" } },
    footer: { title: "AIO Shop", description: "A demonstration website showcasing how to optimize web content for AI recommendations.", categories: { title: "Categories" }, resources: { title: "Resources" }, copyright: { pt1: "© {year} AIO Shop Demo.", pt2: "This is a demonstration site for educational purposes only." } },

    // Other general keys
    product: { addToCart: "Add to Cart", details: "Details", features: "Features", specifications: "Specifications", tooltip: { optimized_description: "Optimized product description", basic_description: "Basic product description", optimized_features: "Optimized feature list", basic_features: "Basic feature list" } },
    greeting: "Hello",
    farewell: "Goodbye",
  ...
  ja: {
    ...
    hero: { // LP Hero keys + Original Hero keys - Japanese
      ...
      cta_button2: "🔹 AIOとは？",
      aio_box: { title: "AIO（AI Optimization）とは？", description: "AIレコメンド時代に最適化された情報構造・意味設計のこと。単なるSEOではなく、AIが「理解しやすく」「紹介しやすい」状態にWebを整える新しいPRの在り方です。" },
      ...
      assistant: { /* ... (Filled Japanese version assumed) ... */ }
    },
    ...
    product: { addToCart: "カートに入れる", details: "詳細", features: "機能", specifications: "仕様", tooltip: { optimized_description: "最適化された商品説明", basic_description: "基本的な商品説明", optimized_features: "最適化された機能リスト", basic_features: "基本的な機能リスト" } },
    greeting: "こんにちは",
    farewell: "さようなら",

    // ★★★ Technical Page Translations - Japanese (Filled based on Claude's examples) ★★★
    technical_page: {
      meta: {
        title: "技術解説 - AI最適化テクニック",
        description: "AI駆動型ショッピングアシスタントでの可視性を向上させる商品ページのAI最適化の技術実装について学びましょう。"
      },
      hero: {
        headline: "技術実装ガイド",
        subheadline: "AIレコメンデーションのために商品ページを最適化する方法"
      },
      understanding: {
        headline: "AI認識の理解",
        paragraph1: "ChatGPT、Claude、GeminiなどのAIショッピングアシスタントは、人間とは異なる方法でWebコンテンツを認識します。従来のSEOがキーワードターゲティングとリンク構築に重点を置いているのに対し、AI最適化では構造化データ、包括的な商品情報、明確なセマンティックコンテンツ構成に重点を置く必要があります。",
        paragraph2: "これらのAIシステムが推奨事項を作成するために商品ページを分析する際、以下のようなページを優先します：",
        list: {
          item1: "簡単に解析できる明確で構造化された情報を持つ",
          item2: "マーケティング文句ではなく、包括的な商品詳細を提供する",
      ...
      key_elements: {
         headline: "主要な最適化要素",
         structured_data: { title: "構造化データ（JSON-LD）", description: "JSON-LD形式でschema.orgマークアップを実装することで、AIシステムが標準化された方法で商品情報を理解するのに役立ちます。これはAI最適化の最も重要な要素かもしれません。" },
         rich_image: { title: "詳細な画像代替テキスト", description: "AIシステムは画像を理解するために代替テキストに大きく依存しています。一般的な代替テキストではなく、商品名、主要機能、コンテキストを含む詳細な説明テキストを提供してください。", standard: "標準的な代替テキスト：", optimized: "AI最適化された代替テキスト：" },
         faq_schema: { title: "FAQスキーマの実装", description: "FAQはユーザーを助けるだけでなく、ユーザーが関連する質問をした際に直接引用できる質問と回答のペアをAIシステムに提供します。" },
         content_organization: { title: "構造化されたコンテンツ組織", description: "適切なセマンティックHTML要素を使用することで、AIがページ上の情報の階層と関係を理解するのに役立ちます。", standard: "標準的なアプローチ：", optimized: "AI最適化されたアプローチ：" }
       },
       checklist: {
         headline: "実装チェックリスト",
         items: {
           title1: "JSON-LD構造化データの実装", description1: "オファー、ブランド、評価など、利用可能なすべてのフィールドを含む完全な商品スキーマを含めます。",
           title2: "商品説明の最適化", description2: "曖昧なマーケティング言語ではなく、具体的な詳細、寸法、材料、使用例を含めます。",
           title3: "すべての画像に詳細な代替テキストを追加", description3: "すべての商品画像の代替テキストに商品名、主要機能、関連するコンテキストを含めます。",
           title4: "FAQスキーマの実装", description4: "詳細な回答を含む一般的な質問に対する包括的なFAQを作成します。",
           title5: "セマンティックHTMLでコンテンツを整理", description5: "コンテンツ構成には、適切なH1-H6見出し、リスト、テーブル、セマンティック要素を使用します。",
           title6: "仕様テーブルの作成", description6: "明確なラベルを持つ構造化されたテーブル形式で技術仕様を提示します。",
           title7: "比較情報の追加", description7: "商品の位置付けを支援するために、類似商品や以前のバージョンとの明確な比較を提供します。"
         }
       },
       testing: {
         headline: "AI最適化のテスト",
    ...
    // ★★★ Diagnostic Tool Page Translations - Japanese (Filled based on Claude's examples) ★★★
    diagnostic_tool_page: {
       meta: {
       ...
       hero: {
         ...
         subheadline: "AIレコメンデーション向けに商品ページがどれだけよく最適化されているかを分析する"
       },
       about: {
       ...
       checks: {
         headline: "チェック項目",
         structure: { title: "構造チェック", items: { item1: "商品構造化データ", item2: "FAQスキーマの実装", item3: "パンくずナビゲーション", item4: "HowToスキーマ（該当する場合）" } },
         metadata: { title: "メタデータチェック", items: { item1: "タイトルタグの最適化", item2: "メタ説明の品質", item3: "Openグラフタグ", item4: "正規URLの実装" } },
         images: { title: "画像チェック", items: { item1: "代替テキストの品質と長さ", item2: "画像命名規則", item3: "複数の商品表示", item4: "画像キャプション" } },
         content: { title: "コンテンツチェック", items: { item1: "見出し構造", item2: "機能リストのフォーマット", item3: "仕様テーブル", item4: "Q&Aコンテンツの構成" } }
       },
       score: {
         headline: "スコアの解釈",
         ranges: {
           range1: "0-40", title1: "改善が必要", description1: "あなたの商品ページにはAI最適化に必要な多くの重要な要素が欠けています。AIアシスタントはあなたの商品を正確に推奨するのに苦労するでしょう。",
           range2: "41-70", title2: "平均的", description2: "あなたの商品ページにはある程度の最適化がありますが、重要な要素が欠けています。AIアシスタントはあなたの商品を推奨するかもしれませんが、詳細は限られています。",
           range3: "71-100", title3: "十分に最適化", description3: "あなたの商品ページはAIの理解のために十分に構造化されています。AIアシスタントはあなたの商品を正確に推奨し説明することができます。"
         },
